import{d as s,r,j as e,m as ae,k as C,a as B,s as ce,u as le,c as Ce,G as Se,l as $e,g as de,f as Ae,n as pe,o as z,p as Ie,q as Me,t as Be,v as Le,W as Re,I as ze,w as Ee,x as Te,y as De,N as Fe}from"./index-U5YyuKpV.js";const Ne=s.div`
  position: fixed;
  bottom: 0px;
  width: inherit;
  display: flex;
...
`;function He({send:n,blocked:c}){const[t,i]=r.useState("");return e.jsxs(Ne,{children:[e.jsx(Ge,{type:"text",value:c?"You are blocked by this user":t,onChange:p=>i(p.target.value)}),e.jsx(Oe,{disabled:t.trim().length<1||c,onClick:()=>{n(t),i("")},children:"send"})]})}const Pe=s.div`
  display: flex;
  align-items: end;
...
`,ut=r.forwardRef(function({show:c,chat:t,loggedUser:i,setDeletedBg:p},g){var _;const[m,x]=r.useState("Choose background"),[f,S]=r.useState(null),[k,E]=r.useState("Choose background"),[v,Y]=r.useState(null),[w,T]=r.useState(""),[D,X]=r.useState(""),[q,J]=r.useState(),[$,L]=r.useState(""),[A,F]=r.useState(),[N,I]=r.useState(!1),[h,G]=r.useState(!1),j=de(),a=B(Ae),u=B(pe).filter(o=>t==null?void 0:t.members.includes(o.id)),d=((i==null?void 0:i.admin)||((_=t.admins)==null?void 0:_.includes(i.id)))&&t.group,O=le();r.useEffect(()=>{t&&(t.name?T(t.name):t.group||T(u.find(o=>o!==i.id).name))},[t]);function Z(){d&&w.length>0&&w.length<21&&j(z({token:i.token,updateData:{name:w},id:t.id}))}function R(){d&&j(z({token:i.token,updateData:{members:[...new Set([...t.members,parseInt(D)])]},id:t.id}))}function H(){d&&j(z({token:i.token,updateData:{members:[...new Set([...t.members.filter(o=>o!==q)])]},id:t.id}))}function he(){d&&j(z({token:i.token,updateData:{public:!t.public},id:t.id}))}function me(){d&&j(z({token:i.token,updateData:{admins:[...new Set([...t.admins,parseInt($)])]},id:t.id}))}function be(){d&&t.admins.length>1&&j(z({token:i.token,updateData:{admins:[...new Set([...t.admins.filter(o=>o!==A)])]},id:t.id}))}async function ve(o){o.preventDefault();const b=new FormData;b.append("name",m),b.append("file",f);try{await C.post(`/api/backgrounds/${m}`,b,{headers:{"Content-Type":"multipart/form-data",Authorization:`bearer ${i.token}`}}),window.location.reload()}catch(M){console.log("Error:",M)}}async function je(){try{(await C.delete(`/api/backgrounds/${i.id}-${t.id}`,{headers:{"Content-Type":"multipart/form-data",Authorization:`bearer ${i.token}`}})).status===200&&p(!0)}catch(o){console.log("Error:",o)}}async function ke(o){o.preventDefault();const b=new FormData;b.append("name",k),b.append("file",v);try{await C.post(`/api/chatAvatars/${k}`,b,{headers:{"Content-Type":"multipart/form-data",Authorization:`bearer ${i.token}`}})}catch(M){console.log("Error:",M)}}async function we(){try{const o=await C.delete(`/api/chatAvatars/${t.id}`,{headers:{"Content-Type":"multipart/form-data",Authorization:`bearer ${i.token}`}})}catch(o){console.log("Error:",o)}}async function ye(){const o={headers:{Authorization:`bearer ${i.token}`}},b={members:t.members.filter(M=>M!==i.id)};t.admins.includes(i.id)&&(b.admins=t.admins.filter(M=>M!==i.id)),await C.patch(`/api/chats/${t.id}`,b,o),j(Ie(t.id)),O("/chats")}return e.jsxs(at,{ref:g,$show:c,children:[e.jsx(ct,{children:"Customize chat"}),d&&e.jsxs(lt,{children:[e.jsxs(P,{children:[e.jsx(dt,{type:"text",disabled:!(t!=null&&t.group),value:w,onChange:o=>T(o.target.value)}),e.jsx(y,{disabled:!(t!=null&&t.group),onClick:Z,children:"Change title"})]}),e.jsxs(P,{children:[e.jsxs(U,{value:D,name:"addContact",onChange:o=>X(o.target.value),children:[e.jsx(V,{},0),a==null?void 0:a.map(o=>e.jsx(V,{value:o.id,children:o.name},o.id))]}),e.jsx(y,{disabled:!D,onClick:R,children:"Add contact"})]}),e.jsxs(P,{children:[e.jsxs(U,{value:$,name:"addAdmin",onChange:o=>L(o.target.value),children:[e.jsx(V,{}),u==null?void 0:u.map(o=>e.jsx(V,{value:o.id,children:o.name},o.id))]}),e.jsx(y,{disabled:!$,onClick:me,children:"Add admin"})]}),e.jsxs("div",{children:[e.jsx(ne,{children:"Chat members"}),e.jsx(ee,{children:u.map(o=>e.jsx(te,{title:"Remove member from chat?",onClick:()=>{I(!0),J(o.id)},children:o.name},o.id))})]}),e.jsxs("div",{children:[e.jsx(ne,{children:"Chat admins"}),e.jsx(ee,{children:u.filter(o=>t.admins.includes(o.id)).map(o=>e.jsx(te,{title:"Remove admin privileges?",onClick:()=>{G(!0),F(o.id)},children:o.name},o.id))})]}),e.jsxs(P,{children:[e.jsx(pt,{htmlFor:"public",children:"Set group to private"}),e.jsx("input",{type:"checkbox",id:"public",checked:!(t!=null&&t.public),onChange:he})]})]}),t.group&&e.jsx(y,{style:{flex:0},onClick:ye,children:"Leave chat"}),e.jsx(y,{onClick:je,style:{textAlign:"center",marginBottom:-10,flex:0},children:"Remove current background"}),e.jsxs(oe,{children:[e.jsxs(se,{id:"background-form",encType:"multipart/form-data",children:[e.jsxs("label",{htmlFor:"background",children:[e.jsx("input",{style:{display:"none"},id:"background",type:"file",name:"background",onChange:o=>{x(`${i.id}-${t.id}`),S(o.target.files[0])}}),e.jsx(re,{type:"button",children:"Choose image"})]}),e.jsx(y,{type:"submit",disabled:!f,style:{flex:0},onClick:o=>ve(o),children:"Set image"})]}),f&&e.jsx(ie,{alt:"chosen background",src:f?URL.createObjectURL(f):`/public/uploads/backgrounds/${i==null?void 0:i.id}-${t==null?void 0:t.id}.webp`})]}),t.group&&e.jsxs(e.Fragment,{children:[e.jsx(y,{onClick:we,style:{textAlign:"center",marginBottom:-10,flex:0},children:"Remove current avatar"}),e.jsxs(oe,{children:[e.jsxs(se,{id:"chat-avatar-form",encType:"multipart/form-data",children:[e.jsxs("label",{htmlFor:"chat-avatar",children:[e.jsx("input",{style:{display:"none"},id:"chat-avatar",type:"file",name:"chat-avatar",onChange:o=>{E(t.id),Y(o.target.files[0])}}),e.jsx(re,{type:"button",children:"Choose image"})]}),e.jsx(y,{type:"submit",disabled:!v,style:{flex:0},onClick:o=>ke(o),children:"Set image"})]}),v&&e.jsx(ie,{alt:"chosen background",src:v?URL.createObjectURL(v):`/public/uploads/chats/${t==null?void 0:t.id}.webp`})]})]}),N&&e.jsx(st,{setShowModal:I,handleRemoveMember:H}),h&&e.jsx(rt,{setShowModal:G,handleRemoveAdmin:be})]})}),xt=s.div`
...
`,bt=s.p`
  overflow-anchor: auto;
  height: 1px;
`;function jt(){const{id:n}=Me(),c=B(ce),t=B(a=>Be(a,n)),i=B(pe),[p,g]=r.useState([]),[m,x]=r.useState(!1),f=de(),S=20,[k,E]=r.useState(!1),v=B(a=>Le(a,n)),[Y,w]=r.useState(!1),[T,D]=r.useState(!1),[X,q]=r.useState(!1),J=r.useRef(null),$=r.useRef(0),L=r.useRef(null),A=r.useRef(!1),F=r.useRef(null),N=r.useRef(!0),I=Ye(F,document.getElementById("vp")),h=r.useContext(Re),G=r.useCallback(async a=>{const{token:l,id:u,offset:d,limit:O}=a,Z={headers:{Authorization:`bearer ${l}`}},R=await C.get(`/api/messages/chat/${u}?pagination=${d},${O}`,Z);if(E(!1),R.data.length!==O&&(A.current=!0),!R.data.length){A.current=!0;return}g(H=>H.length?[...H,...R.data]:[...R.data])},[]);if(r.useEffect(()=>{E(!0),I&&!A.current&&(G({token:c.token,id:n,offset:$.current,limit:S}),$.current+=S)},[I,c,n,G]),r.useEffect(()=>{if(E(!1),L.current&&(L.current.childNodes.forEach(l=>l.classList.remove("date")),Object.keys(Object.groupBy(p,({createdAt:l})=>new Date(l).toLocaleString("en-GB").slice(0,10))).forEach(l=>{const u=document.querySelectorAll(`[data-date="${l}"]`);u[u.length-1].classList.add("date")})),N.current&&p.length){const a=document.getElementById("vp");setTimeout(()=>a.scrollTop=a.scrollHeight,100),N.current=!1}},[p]),r.useEffect(()=>{!N.current&&h&&h.chatId==n&&(g(a=>a.length?a.map(l=>l.id).includes(h.id)?a.map(l=>l.id===h.id?h:l):[h,...a.filter(l=>l.id!==h.id)]:[h]),$.current+=1)},[h,n,c]),r.useLayoutEffect(()=>{const a=document.getElementById("vp");let l=0;function u(d){d.target.scrollTop<100&&(d.target.scrollTop=100),d.target.scrollHeight-d.target.scrollTop<d.target.offsetHeight+50&&f(De({token:c.token,count:0,chatId:n})),d.target.scrollHeight-d.target.scrollTop>d.target.offsetHeight+500?d.target.scrollTop-l>10&&d.target.scrollTop-l<500?w(!0):d.target.scrollTop<l&&w(!1):w(!1),l=d.target.scrollTop}return a.addEventListener("scroll",u),()=>{a.removeEventListener("scroll",u)}},[]),!t||!i||i.find(a=>a.id===t.members.find(l=>l!==c.id))===void 0)return e.jsx(K,{endRef:F,loading:I&&k&&!A.current});async function j(a){const l={headers:{Authorization:`bearer ${c.token}`}};try{await C.post("/api/messages",{chatId:t.id,text:a},l)}catch(u){u.response.data.error==="You are blocked by this user"&&x(!0)}}return e.jsxs(xt,{$backgroundUrl:X?"":`/public/uploads/backgrounds/${c==null?void 0:c.id}-${t==null?void 0:t.id}.webp`,children:[e.jsxs(gt,{children:[e.jsx(ze.Provider,{value:{color:"gold",size:"2em"},children:e.jsx(ft,{to:"/chats",title:"Go back",children:e.jsx(Ee,{})})}),t.name||i.find(a=>a.id===t.members.find(l=>l!==c.id)).name,e.jsx(ht,{onClick:()=>D(a=>!a),children:e.jsx("img",{src:Te,title:"Chat settings",style:{filter:"brightness(0) saturate(100%) invert(91%) sepia(17%) saturate(4935%) hue-rotate(357deg) brightness(99%) contrast(105%)"}})})]}),e.jsxs(mt,{ref:L,$limit:S,children:[e.jsx(bt,{}),p.map(a=>{var l;return e.jsxs(et,{parentWidth:(l=L.current)==null?void 0:l.offsetWidth,message:a,setMessages:g,children:[a.id,": ",a.text]},a.id)}),e.jsx(K,{endRef:F,loading:I&&k&&!A.current,style:{marginBottom:100}})]}),e.jsx(He,{send:j,blocked:m}),e.jsx(it,{unseen:v==null?void 0:v.count,scrollDown:Y}),e.jsx(ut,{ref:J,show:T,chat:t,loggedUser:c,setDeletedBg:q})]})}export{jt as default};
