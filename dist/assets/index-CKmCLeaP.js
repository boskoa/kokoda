import{d as s,r,j as e,m as ae,k as C,a as B,s as ce,u as le,c as Ce,G as Se,l as $e,g as de,f as Ae,n as pe,o as z,p as Ie,q as Me,t as Be,v as Ee,W as Re,I as Te,w as ze,x as Le,y as De,N as Fe}from"./index-DcpMZKmg.js";const Ne=s.div`
  position: fixed;
  bottom: 0px;
  width: inherit;
  display: flex;
...
`;function He({send:n,blocked:c}){const[t,i]=r.useState("");return e.jsxs(Ne,{children:[e.jsx("label",{htmlFor:"messageInput"}),e.jsx(Ge,{id:"messageInput",type:"text",value:c?"You are blocked by this user":t,onChange:p=>i(p.target.value)}),e.jsx(Oe,{disabled:t.trim().length<1||c,onClick:()=>{n(t),i("")},children:"send"})]})}const Pe=s.div`
  display: flex;
  align-items: end;
